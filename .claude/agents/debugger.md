...
- Measure before/after with real evidence, matching this project's existing practice in `DEVELOPMENT_BUILD_PLAN.md` (e.g. the overlay-trigger-reach and overlay-stability entries) rather than reasoning about a fix without proof.
