...
| Field | Current value |
|---|---|
| Overall state | M00-M11 are complete. M12's packaging works and is validated structurally; its disposable-environment install matrix is outstanding, as is all of M13 and M14. `v0.1.3` is published as the latest release and is publicly downloadable. It is unsigned and predates M14, so R01 stays unchecked |
