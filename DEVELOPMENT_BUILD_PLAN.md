...
| Next exact action | Perform an authorized real Codex account comparison with `--enable-codex`; validate source, request, snapshot, overlay/details, cache restore, offline behavior, and shutdown. Do not use or record raw credentials |
